...
<%
    ...
    ' Cek Transaksi ( Status Pembayaran - N ) 
        ...
        Transaksi_H_CMD.commandText = "SELECT  MKT_T_Transaksi_H.trID, MKT_T_Transaksi_H.trPembayaranYN, MKT_T_Transaksi_D1.tr_IDBooking FROM MKT_T_Transaksi_H LEFT OUTER JOIN MKT_T_Transaksi_D1 ON MKT_T_Transaksi_H.trID = LEFT(MKT_T_Transaksi_D1.trD1,12) WHERE trPembayaranYN = 'N'"
