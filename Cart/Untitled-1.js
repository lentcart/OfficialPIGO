            ...
            function listongkir(id){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        var c = document.getElementById("liiissssttttt"+id); 
                        ...
                        $.each(jsonData, function(i, jsonData) {
                            ...
                            c.appendChild(document.createTextNode(jsonData.tag_name));
                        ...
                        // var string1 = JSON.stringify(key);
                    ...
                    <div class="col-12">
                        ...
                        <div class="card-pesanan mb-2">
                            ...
                            <div class="row">
                                ...
                                %>
                                <input class="txt-pesanan" type="text" name="asalkota" id="asalkota<%=seller("cart_slID")%>" value="<%=alamattoko("almKota")%>" style="width:17rem">
                            ...
                            <div class="list-ongkir" id="cont-list-ongkir<%=seller("cart_slID")%>" style="display:none">
                                <div id="liiissssttttt<%=seller("cart_slID")%>">
