...
<!--Breadcrumb-->
    ...
    <form class="pesananbaru" action="P-pesananbaru.asp" method="POST">
        <div class="container mt-2 mb-2 detail-pesananbaru">
            <div class="row">
                ...
                <span class="text-detailjudul"> Data Transaksi </span>
                    <div class="row mt-1">
                        <div class="col-12">
                            <span class="text-detail"> Kode Transaksi  : <input class="text-center inp-detailpesanan" type="text" name="nopesanan" id="nopesanan" value="<%=seller("trID")%>"> / <input class="text-center inp-detailpesanan" type="text" name="tglpesanan" id="tglpesanan" value="<%=Cdate(seller("trTglTransaksi"))%>">  [ <%=seller("strName")%> ]</span><br>
                        </div>
                    </div>
                </div>
                <div class="col-6">
        ...
        <div class="container mt-2 mb-2 detail-pesananbaru">
                    ...
                    <table class="table table-bordered table-condensed" style="font-size:12px font-weight:500">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <input type="hidden" name="panjang" id="panjang" value="<%=produk("pdPanjang")%>">
                                <input type="hidden" name="tinggi" id="tinggi" value="<%=produk("pdTInggi")%>">
                                <input type="hidden" name="lebar" id="lebar" value="<%=produk("pdLebar")%>">
                                <% ukuran = produk("pdPanjang")*produk("pdLebar")*produk("pdTInggi") %>
                    ...
                    <div class="row mt-2">
                        <div class="col-2">
                            <select required class="text-detail"  name="statustransaksi" id="statustransaksi">
                                ...
                                <option value="01"> Pesanan Diproses </option>
                                <option value="05"> Menunggu Pengambilan </option>
                            </select>
                        </div>
                        <div class="col-2">
            ...
            <div class="row align-items-center mb-4 mt-3 d-flex flex-row-reverse">
                <div class="col-12">
                    <button onclick="sendajax()" > Get ID Booking </button>
                </div>
            </div>
        </div>
    </form>
