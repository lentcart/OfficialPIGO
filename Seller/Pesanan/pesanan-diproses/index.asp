...
%>
<span class="txt-Judul" >Pesanan Diproses</span>
    <table class="table table-bordered table-condensed mt-2" style="font-size:11px">
        ...
        <tr>
            ...
            <td class=" text-center" ><a href="pesanan-diproses/detail.asp?trID=<%=pdtr("trID")%>" style="font-size:11px"> Rincian Pesanan </a></td>
        </tr>
        <%pdtr.movenext
        loop%>
        <%Transaksi.movenext
