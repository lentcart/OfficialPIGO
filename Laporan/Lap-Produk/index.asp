...
<%
	...
	Supplier_P_cmd.commandText = "SELECT dbo.MKT_M_Supplier.spID, dbo.MKT_M_Supplier.spNama, dbo.MKT_M_Supplier.spAlmLengkap, dbo.MKT_M_Supplier.spAlmProvinsi, dbo.MKT_M_Supplier.spTelp1, dbo.MKT_M_Supplier.spTelp2, dbo.MKT_M_Supplier.spTelp3, dbo.MKT_M_Supplier.spEmail, dbo.MKT_M_Supplier.spDesc, dbo.MKT_M_Supplier.spUpdateTime, dbo.MKT_M_Supplier_P.sp_pdID, dbo.MKT_M_Supplier_P.sp_spNama, dbo.MKT_M_Supplier_P.sp_pdNama, dbo.MKT_M_Supplier_P.sp_pdQty, dbo.MKT_M_Supplier_P.sp_pdHarga, dbo.MKT_M_Supplier_P.sp_pdType, dbo.MKT_M_Supplier_P.sp_pdMerk, dbo.MKT_M_Supplier_P.sp_pdKat,  dbo.MKT_M_Supplier_P.sp_pdTglPembelian, dbo.MKT_M_Supplier_P.sp_pdUpdateTime FROM dbo.MKT_M_Supplier LEFT OUTER JOIN dbo.MKT_M_Supplier_P ON dbo.MKT_M_Supplier.spID = dbo.MKT_M_Supplier_P.sp_spNama where MKT_M_Supplier_P.sp_pdAktifYn = 'Y' " 
	...
	sp_cmd.commandText = "SELECT * From MKT_M_Supplier where spAktifYN = 'Y' " 
