...
<html lang="en">
    ...
    <body onload="loaddata()">
        ...
        <div class="container" style="margin-top:8rem;">
            ...
            <form class="formck" action="detailtest.asp" method="POST">
                <div class="row align-items-center first-cart">
                    <div class="col-8">
                ...
                <div class="row align-items-center">
                    <div class="col-8">
                        ...
                        <script>
                            function tambahqty<%=pdID("pdID")%>(ck,e,pdid) {
                                ...
                                let MaxQTY = document.getElementById("tes<%=pdID("pdID")%>").max;
                                var SumQTY = 0;
                                    if ( Input >= MaxQTY ){
                                        alert("Stok Produk Ini " + MaxQTY + " Dikeranjangmu Sudah Ada " + MaxQTY);
                                    }else{
                                        SumQTY = Input++ +1;
                                        $.ajax({
                                            type: "GET",
                            ...
                            function kurangqty<%=pdID("pdID")%>(ck,e,pdid) {
                                let Inputt = document.getElementById("tes<%=pdID("pdID")%>").value;
                                let total = document.getElementById("total").value;
                                let MaxQTY = document.getElementById("tes<%=pdID("pdID")%>").min;
                                var SumQTY = 0;
                        ...
                        <div class="pd-seller mt-2" id="produk">
                            <div class="row align-items-center">
                                <div class="col-1">
                                    <input class="form-check-input " type="checkbox" onclick="ck()" onchange="checkbarang<%=pdID("pdID")%>(this,<%=pdID("cartQty")%>,<%=pdID("pdHargaJual")%>)" value="<%=pdID("pdID")%>" name="checkbox-barang" id="<%=pdID("pdID")%>">
                                    <!--
                                ...
                                <div class="col-6">
                                    ...
                                    <% end if %>
                                    <input class="txt-produk-harga" type="text" name="" id="" value="<%=Replace(Replace(FormatCurrency(pdId("pdhargaJual")),"$","Rp. "),".00","")%>" readonly><br>
                                    <div class="row">
                                        <div class="col-3 ">
                                ...
                                <div class="col-2">
                                    ...
                                    <input class="inp-qty" name="tes" id="tes<%=pdID("pdID")%>" value="<%=pdID("cartQty")%>" min="1" max="<%=pdID("pdStok")%>">
                    ...
                    <div class="col-4">
                        ...
                        <div class="pd-seller align-items-center"  >
                        ...
                        <div class="pd-seller align-items-center mt-3" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <input  class="txt-desc-cart inp-total"readonly type="number" name="tbarang" id="tbarang" value="0" onblur="tbarang()"><br>
                                    <input  class="txt-desc-cart inp-total"readonly type="number" name="total" id="total" value="0"><br>
                                    <input  class="txt-desc-cart inp-total"readonly type="number" name="diskon" id="diskon" value="0">
                                </div>
                            </div>
