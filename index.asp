...
<body>
    ...
    <div class="container" style="margin-top:2rem">
        ...
        <!-- Produk -->
            ...
            <div class="row mt-4 text-center">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <button class="btn-produk-rekom"> LIHAT LAINNYA </button>
                </div>
            </div>
        <!-- Produk -->
    ...
    <script>
        ...
        function sendChat(){
            $.ajax({
                type: "get",
                url: "ChatLive/chatseller.asp?isipesan="+document.getElementById("isipesan").value+"&kodeseller="+document.getElementById("kodeseller").value,
