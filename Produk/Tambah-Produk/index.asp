...
<html lang="en">
    ...
    <script>
        ...
        if(namaproduk < 5){
            $('#notif-namaproduk').show();
        }else{
            $('#notif-namaproduk').hide();
        }
    }
            ...
            <div class="col-12  div-produk">
                <div class="navigasi" >
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb ">
                            <li class=" txt-desc breadcrumb-item"><a href="../../Seller/" >Seller Home</a></li>
                            <li class=" txt-desc breadcrumb-item"><a href="../Daftar-Produk/">Daftar Produk</a></li>
                            <li class=" txt-desc breadcrumb-item"><a href="index.asp">Tambah Produk</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="div-tambah-produk mt-4 mb-2">
                    <div class="row" >
                        <div class="col-lg-0 col-md-0 col-sm-0 col-12">
                            <span class="txt-judul mb-2" style="font-size:20px">Informasi Produk</span>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-lg-0 col-md-0 col-sm-0 col-9">
                                    <input onkeyup="notif()" name="namaproduk" id="namaproduk" required class="form-tambah-produk" value="">
                                    <span class="cont-desc" id="notif-namaproduk" style="display:none">Nama produk terlalu pendek. Mohon masukkan min. 5 karakter.</span>
                                </div>
                            </div>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-lg-0 col-md-0 col-sm-0 col-9  mt-2">
                                    <input type="text" name="type" id="type" class="form-tambah-produk mt-2 " required>
                                </div>
                            </div>
                    ...
                    <div class="row mt-4" >
                        <div class="col-lg-0 col-md-0 col-sm-0 col-12">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-0 col-md-0 col-sm-0 col-9">
                                    <input name="stok" id="stok" type="number" class="text-center form-tambah-produk txt-desc" style="width:26rem; height:38px" placeholder="Masukan Jumlah Stok Produk" value="1" required>
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-0 col-md-0 col-sm-0 col-9 ">
                                    <input name="sku" id="sku" type="text" class="form-tambah-produk txt-desc" style="width:26rem; height:38px" placeholder="Masukan SKU" required >
                                </div>
                            </div>
                        ...
                        <div class="col-lg-0 col-md-0 col-sm-0 col-12">
                            ...
                            <div class="row">
                                <div class="col-lg-0 col-md-0 col-sm-0 col-3 mt-4">
                                    ...
                                    <p class="text-desc" >jika Kenaikan harga bisa diisikan 0 (Nol) jika tidak terdapat ketentuan perhitungan kenaikan harga dari setia produk</p>
                                </div>
                                <div class="col-lg-0 col-md-0 col-sm-0 col-9 mt-4">
                                    <div class="row">
                                        <div class="col-3">
                                            <span class="txt-desc"> Harga Beli </span>
                                            <p class="text-desc" >Harga jual sebelum PPN</p>
                                        </div>
                                        <div class="col-6">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="basic-addon2">Rp.</span>
                                                <div class="input-group-append">
                                                    <input onkeyup="harga()" name="hargabeli" id="hargabeli" type="number" class="form-tambah-desc" style="width:10rem; height:38px; border-top-right-radius:10px;border-bottom-right-radius:10px" required >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 mb-3">
                                            <div class="input-group ">
                                                <div class="input-group-append">
                                                    <input onkeyup="harga()" name="ppn" id="ppn" type="number"  class=" text-center form-tambah-desc" value="11"style="width:11rem; height:38px; border-top-left-radius:10px;border-bottom-left-radius:10px" required >
                                                </div>
                                                <span class="input-group-text" id="basic-addon2">%</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            ...
                                            <p class="text-desc" >Harga jual setelah PPN</p>
                                        </div>
                                        <div class="col-6">
                                            <div class="input-group">
                                            <span class="input-group-text" id="basic-addon2">Rp.</span>
                        ...
                        <div class="col-lg-0 col-md-0 col-sm-0 col-12">
                            ...
                            <div class="row">
                                <div class="col-lg-0 col-md-0 col-sm-0 col-3 mt-4">
                                    ...
                                    <p class="text-desc" >Hitung nilai berat menyesuaikan produk setelah packing, jika ada ketidaksesuaian ukuran pada pengecekan di pihak pengiriman biaya akan dibebankan ke pihak seller</p>
                                </div>
                                <div class="col-lg-0 col-md-0 col-sm-0 col-9 mt-4">
                                    <div class="input-group mb-3">
                                    <input name="berat" id="berat" type="number" class="form-tambah-produk txt-desc" style="width:15rem; heigth:100px" placeholder="Gram" required>
                                        <div class="input-group-append">
                            ...
                            <div class="row mt-4">
                                <div class="col-lg-0 col-md-0 col-sm-0 col-3 ">
                                    ...
                                    <p class="text-desc" >Hitung nilai volume menyesuaikan produk setelah packing, jika ada ketidaksesuaian ukuran pada pengecekan di pihak pengiriman biaya akan dibebankan ke pihak seller</p>
                                </div>
                                <div class="col-lg-0 col-md-0 col-sm-0 col-9">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-0 col-md-0 col-sm-0 col-6">
                                            <div class="input-group mb-3">
                                                <input onkeyup="nilaivolume()" name="panjang" id="panjang" type="number" class="form-tambah-produk txt-desc" style="width:8rem; heigth:20px" value="" required>
                                                <div class="input-group-append">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-0 col-md-0 col-sm-0 col-9 mt-2">
                                            <div class="input-group mb-3">
                                                <input onkeyup="nilaivolume()" name="lebar" id="lebar" type="number" class="form-tambah-produk txt-desc" style="width:8rem; heigth:20px" value="" required>
                                                <div class="input-group-append">
                                                    <span class="input-group-text" id="basic-addon2">cm</span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-0 col-md-0 col-sm-0 col-6 mt-2">
                                            <div class="input-group mb-3">
                                                <input onkeyup="nilaivolume()" name="tinggi" id="tinggi" type="number" class="form-tambah-produk txt-desc" style="width:8rem; heigth:20px" value="" required>
                                                <div class="input-group-append">
                                                    <span class="input-group-text" id="basic-addon2">cm</span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-0 col-md-0 col-sm-0 col-4 mt-2">
                                            <input  name="totVol" id="totVol" type="readonly" class="form-tambah-produk txt-desc" style="width:19rem; text-align:center" readonly >
                                        </div>
                                    </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-3">
                                    <span class="txt-desc"> Alamat Pick UP</span>
                                    <p class="text-desc" > Setiap seller hanya memiliki satu alamat pick up barang </p>
                                </div>
                                <div class="col-9">
                                    <div class="form-check">
                                        <input class="form-check-input txt-desc" type="checkbox" name="layanan" id="layanan" value="<%=Alamat("almID") %>" checked disabled>
                                        <label class="form-check-label txt-desc" for="gridRadios1">
                                        <%=Alamat("almKota")%>
                                        </label><br>
                                        <span class=" text-desc"><i> *Alamat Utama Pick UP </i></span>
                                    </div>
                                </div>
                            </div>
