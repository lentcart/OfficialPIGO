...
%>
<span><b> Pesanan Sedang Dalam Pengiriman </b></span>
    <table class="table table-bordered table-condensed mt-2" style="font-size:11px">
        ...
        <tr>
            ...
            <td class=" text-center" ><a href="pesanan-dikirim/detail.asp?trID=<%=pdtr("trID")%>&slID=<%=transaksi("tr_slID")%>" style="font-size:11px"> Pesanan Diterima </a></td>
        <%pdtr.movenext
            loop%> 
        </tr>
        <%Transaksi.movenext
