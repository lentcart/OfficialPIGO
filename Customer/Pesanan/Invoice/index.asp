...
<html lang="en">
    ...
    var date = today.getFullYear()+'-'+(today.getMonth()+1)+'-'+today.getDate();
        // window.print();
        document.title = "INV-"+today.getDate()+'/'+(today.getMonth()+1)+'/'+today.getFullYear()+"/<%=trID%>";
            ...
            <div class="subpage">
                <div class="row align-items-center">
                    ...
                    <div class="col-10">
                        ...
                        <span class="Judul-Merchant" style="font-size:15px; color:#0077a2"><b>INV/<%=trID%>/<%=Cdate(date())%></b></span><br>
                    </div>
                </div>
                    ...
                    <div class="col-7">
                        ...
                        <div class="row">
                            ...
                            <div class="col-7">
                                ...
                                <span> : </span> &nbsp; <span> <%=day(Merchant("trTglTransaksi"))%> - <%=MonthName(Month(Merchant("trTglTransaksi")))%> - <%=year(Merchant("trTglTransaksi"))%> </span><br>
                ...
                <div class="row mt-2">
                    <div class="col-12">
                        <%
                            ...
                            Produk_cmd.commandText = "SELECT MKT_T_Transaksi_D1A.tr_pdID, MKT_T_Transaksi_D1A.tr_pdQty, MKT_T_Transaksi_D1A.tr_pdHarga, MKT_M_Produk.pdNama, MKT_M_Produk.pdBerat FROM MKT_M_Produk RIGHT OUTER JOIN MKT_M_Customer ON MKT_M_Produk.pd_custID = MKT_M_Customer.custID RIGHT OUTER JOIN MKT_T_Transaksi_D1A ON MKT_M_Produk.pdID = MKT_T_Transaksi_D1A.tr_pdID RIGHT OUTER JOIN MKT_T_Transaksi_D1 RIGHT OUTER JOIN MKT_T_Transaksi_H ON LEFT(MKT_T_Transaksi_D1.trD1, 12) = MKT_T_Transaksi_H.trID ON MKT_T_Transaksi_D1A.trD1A = MKT_T_Transaksi_H.trID WHERE (MKT_T_Transaksi_H.trID = '"& trID &"') AND (MKT_M_Produk.pd_custID = '"& Merchant("sl_custID") &"')"
                            set Produk = Produk_cmd.execute
                        %>
                        <div class="watermark text-center">
                            <div class="row text-center" style="color:white">
                                <div class="col-12">
                                    <span class="txt1"> OFFICIAL </span><span class="txt2">PIGO</span>
                                </div>
                            </div>
                        </div>
