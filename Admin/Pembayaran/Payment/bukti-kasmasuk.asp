...
<%
	...
	Payment_cmd.commandText = "SELECT MKT_M_Customer.custNama, MKT_M_Customer.custID,MKT_T_Payment_H.payID, MKT_T_Faktur_Penjualan.InvARID, MKT_T_Payment_H.payTanggal, MKT_T_Payment_H.payType FROM MKT_T_Faktur_Penjualan RIGHT OUTER JOIN MKT_T_Payment_D ON MKT_T_Faktur_Penjualan.InvARID = MKT_T_Payment_D.pay_Ref RIGHT OUTER JOIN MKT_M_Customer RIGHT OUTER JOIN MKT_T_Payment_H ON MKT_M_Customer.custID = MKT_T_Payment_H.pay_custID ON MKT_T_Payment_D.payID_H = MKT_T_Payment_H.payID where MKT_T_Payment_H.payID = '"& payID &"'GROUP BY MKT_M_Customer.custNama,MKT_M_Customer.custID, MKT_T_Payment_H.payID, MKT_T_Faktur_Penjualan.InvARID, MKT_T_Payment_H.payTanggal, MKT_T_Payment_H.payType "
        ...
        <div class="page">
            <div class="subpage">
                ...
                <div class="row text-center mt-3 mt-3">
                    <div class="col-12">
                        <span class="cont-text" style="font-size:20px"><u><b>TANDA BUKTI BANK/KAS MASUK</b></u></span><br>
                ...
                <% if Payment("payType") = "02" then %>
                    <div class="row mt-3">
                        <div class="col-3">
                            <span class="cont-text">Diterima Dari</span><br>
                        </div>
                        <div class="col-9 p-0">
                    ...
                    <div class="row mt-2">
                        <div class="col-12">
                            <div class="panel panel-default">
                                ...
                                <tbody>
                                <% 
                                Payment_cmd.commandText = "SELECT MKT_T_Faktur_Penjualan.InvAR_custID, MKT_T_Payment_D.pay_Ref, MKT_T_Payment_D.pay_Total, MKT_T_Payment_D.pay_Dibayar, MKT_T_Payment_D.pay_Subtotal, MKT_T_Faktur_Penjualan.InvARID, MKT_T_Faktur_Penjualan.InvARTanggal FROM MKT_T_Faktur_Penjualan RIGHT OUTER JOIN MKT_T_Payment_D ON MKT_T_Faktur_Penjualan.InvARID = MKT_T_Payment_D.pay_Ref RIGHT OUTER JOIN MKT_T_Payment_H ON MKT_T_Payment_D.payID_H = MKT_T_Payment_H.payID WHERE MKT_T_Payment_H.payID = '"& payment("payID") &"' AND MKT_T_Payment_H.pay_custID = '"& Payment("custID") &"' "
                                'response.write Payment_cmd.commandText
                            ...
                            %>
                                <tr>
                                    ...
                                    <td> Terima Pembayaran INV-AR  <b>[ <%=paymentdetail("InvARID")%> - <%=CDate(paymentdetail("InvARTanggal"))%> ]</b></td>
                ...
                <% else %>
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-9 p-0">
                            ...
                            %>
                            <span class="cont-text">:</span>&nbsp;&nbsp;<span class="cont-text"><%=Rekening("BankName")%>&nbsp; <b> <%=Rekening("rkNomorRK")%> </b>&nbsp; a/n &nbsp; <%=Rekening("rkNamaPemilik")%> </span><br>
                        </div>
                    </div>
                    <!--<div class="row mt-1">
                        <div class="col-3">
