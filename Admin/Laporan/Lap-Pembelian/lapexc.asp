...
<%
	...
	Pembelian_cmd.commandText = "SELECT MKT_T_MaterialReceipt_H.mmID, MKT_T_MaterialReceipt_H.mmTanggal, MKT_M_Supplier.spID, MKT_M_Supplier.spNama1, MKT_M_Supplier.spAlamat, MKT_M_Supplier.spPhone1, MKT_M_Supplier.spPhone2, MKT_M_PIGO_Produk.pdID,  MKT_M_PIGO_Produk.pdNama, MKT_M_PIGO_Produk.pdUnit, MKT_M_PIGO_Produk.pdPartNumber, MKT_T_MaterialReceipt_D2.mm_pdQtyDiterima, MKT_T_MaterialReceipt_D2.mm_pdHarga,  MKT_T_MaterialReceipt_D2.mm_pdSubtotal,MKT_M_PIGO_Produk.pdTypeProduk FROM MKT_M_PIGO_Produk RIGHT OUTER JOIN MKT_T_MaterialReceipt_D2 ON MKT_M_PIGO_Produk.pdID = MKT_T_MaterialReceipt_D2.mm_pdID RIGHT OUTER JOIN MKT_M_Supplier RIGHT OUTER JOIN MKT_T_MaterialReceipt_H ON MKT_M_Supplier.spID = MKT_T_MaterialReceipt_H.mm_spID ON MKT_T_MaterialReceipt_D2.mmID_D2 = MKT_T_MaterialReceipt_H.mmID LEFT OUTER JOIN MKT_T_MaterialReceipt_D1 ON MKT_T_MaterialReceipt_H.mmID = MKT_T_MaterialReceipt_D1.mmID_D1  WHERE MKT_T_MaterialReceipt_H.mm_custID = '"& request.Cookies("custID") &"' "& FilterFix & filterTanggal &"  GROUP BY MKT_T_MaterialReceipt_H.mmID, MKT_T_MaterialReceipt_H.mmTanggal, MKT_M_Supplier.spID, MKT_M_Supplier.spNama1, MKT_M_Supplier.spAlamat, MKT_M_Supplier.spPhone1, MKT_M_PIGO_Produk.pdID,  MKT_M_PIGO_Produk.pdNama, MKT_M_PIGO_Produk.pdUnit, MKT_M_PIGO_Produk.pdPartNumber, MKT_T_MaterialReceipt_D2.mm_pdQtyDiterima, MKT_T_MaterialReceipt_D2.mm_pdHarga,  MKT_T_MaterialReceipt_D2.mm_pdSubtotal,MKT_M_PIGO_Produk.pdTypeProduk,MKT_M_Supplier.spPhone2 "
...
<table>
    ...
    <tr>
        <td><%=no%></td>
        <td><%=Cdate(Pembelian("mmTanggal"))%></td>
        <td><%=Pembelian("spNama1")%></td>
        <td>'0<%=Pembelian("spPhone1")%></td>
        <td><%=Pembelian("spAlamat")%></td>
        <td><%=Pembelian("pdNama")%></td>
        <td><%=Pembelian("pdTypeProduk")%></td>
        <td ><%=Pembelian("mm_pdHarga")%></td>
        <td><%=Pembelian("mm_pdQtyDiterima")%></td>
        <%total = Pembelian("mm_pdQtyDiterima") * Pembelian("mm_pdHarga") %>
        <td><%=total%></td>
