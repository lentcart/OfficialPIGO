...
<%
	...
	BussinesPartner_cmd.activeConnection = MM_PIGO_String
        ...
        BussinesPartner_cmd.commandText = "SELECT MKT_T_MaterialReceipt_H.mm_custID, MKT_M_Customer.custNama FROM MKT_M_Customer RIGHT OUTER JOIN MKT_T_MaterialReceipt_H ON MKT_M_Customer.custID = MKT_T_MaterialReceipt_H.mm_custID  WHERE custID = '"& id &"' GROUP BY MKT_T_MaterialReceipt_H.mm_custID, MKT_M_Customer.custNama "
	...
	BussinesPartner_cmd.activeConnection = MM_PIGO_String
        ...
        BussinesPartner_cmd.commandText = "SELECT MKT_T_MaterialReceipt_H.mm_custID, MKT_M_Customer.custNama FROM MKT_M_Customer RIGHT OUTER JOIN MKT_T_MaterialReceipt_H ON MKT_M_Customer.custID = MKT_T_MaterialReceipt_H.mm_custID  WHERE "& FilterFix &" GROUP BY MKT_T_MaterialReceipt_H.mm_custID, MKT_M_Customer.custNama "
        'response.write BussinesPartner_cmd.commandText
