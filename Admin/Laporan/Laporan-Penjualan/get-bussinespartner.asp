...
<%
	...
	BussinesPartner_cmd.activeConnection = MM_PIGO_String
        ...
        BussinesPartner_cmd.commandText = "SELECT MKT_M_Customer.custID, MKT_M_Customer.custNama FROM MKT_M_Customer RIGHT OUTER JOIN MKT_T_Permintaan_Barang_H ON MKT_M_Customer.custID = MKT_T_Permintaan_Barang_H.Perm_custID WHERE custID = '"& id &"' GROUP BY MKT_M_Customer.custID, MKT_M_Customer.custNama ORDER BY custNama ASC  "
	...
	BussinesPartner_cmd.activeConnection = MM_PIGO_String
        ...
        BussinesPartner_cmd.commandText = "SELECT MKT_M_Customer.custID, MKT_M_Customer.custNama FROM MKT_M_Customer RIGHT OUTER JOIN MKT_T_Permintaan_Barang_H ON MKT_M_Customer.custID = MKT_T_Permintaan_Barang_H.Perm_custID  WHERE "& FilterFix &"  GROUP BY MKT_M_Customer.custID, MKT_M_Customer.custNama ORDER BY custNama ASC"
        'response.write BussinesPartner_cmd.commandText
