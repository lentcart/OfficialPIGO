...
<%
	...
	PurchaseOrder_cmd.activeConnection = MM_PIGO_String
        ...
        PurchaseOrder_cmd.commandText ="SELECT MKT_M_Supplier.spID, MKT_M_Supplier.spNama1, MKT_M_Supplier.spTransaksi, MKT_M_Supplier.spAlamat, MKT_M_Supplier.spPhone1, MKT_M_Supplier.spNamaCP, MKT_T_PurchaseOrder_H.poID,  MKT_T_PurchaseOrder_H.poTanggal FROM MKT_M_Supplier RIGHT OUTER JOIN MKT_T_PurchaseOrder_H ON MKT_M_Supplier.spID = MKT_T_PurchaseOrder_H.po_spID WHERE MKT_T_PurchaseOrder_H.poJenisOrder = '"& jenisorder &"' AND MKT_T_PurchaseOrder_H.poTanggal between '"& tgla &"' AND '"& tgle &"' GROUP BY MKT_M_Supplier.spID, MKT_M_Supplier.spNama1, MKT_M_Supplier.spTransaksi, MKT_M_Supplier.spAlamat, MKT_M_Supplier.spPhone1, MKT_M_Supplier.spNamaCP, MKT_T_PurchaseOrder_H.poID,  MKT_T_PurchaseOrder_H.poTanggal ORDER BY  MKT_T_PurchaseOrder_H.poTanggal ASC" 
            ...
            <div class="subpage">
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        ...
                        <span> <%=PurchaseOrder("spNama1")%> </span><br>
                        <span> <%=PurchaseOrder("spAlamat")%> </span><br>
                    </div>
                </div>
                <div class="row mt-3 mb-3">
                    <div class="col-12">
