...
<%
	...
	PurchaseOrder_cmd.activeConnection = MM_PIGO_String
        PurchaseOrder_cmd.commandText ="SELECT ROW_NUMBER() OVER(ORDER BY pdNama) AS no,MKT_T_PurchaseOrder_H.poID, MKT_T_PurchaseOrder_H.poTanggal, MKT_T_PurchaseOrder_H.po_custID, MKT_M_Customer.custNama, MKT_M_Customer.custEmail, MKT_M_Customer.custPhone1,  MKT_M_Customer.custPaymentTerm, MKT_M_Customer.custNamaCP, MKT_T_PurchaseOrder_D.po_pdID, MKT_T_PurchaseOrder_D.poQtyProduk, MKT_T_PurchaseOrder_D.poPdUnit, MKT_T_PurchaseOrder_D.poPajak,  MKT_T_PurchaseOrder_D.poHargaSatuan, MKT_M_PIGO_Produk.pdNama, MKT_M_PIGO_Produk.pdUnit, MKT_M_PIGO_Produk.pdPartNumber FROM MKT_M_PIGO_Produk RIGHT OUTER JOIN MKT_T_PurchaseOrder_D ON MKT_M_PIGO_Produk.pdID = MKT_T_PurchaseOrder_D.po_pdID RIGHT OUTER JOIN MKT_M_Customer RIGHT OUTER JOIN MKT_T_PurchaseOrder_H ON MKT_M_Customer.custID = MKT_T_PurchaseOrder_H.po_custID ON MKT_T_PurchaseOrder_D.poID_H = MKT_T_PurchaseOrder_H.poID WHERE MKT_M_PIGO_Produk.pdNama = '"& namapd &"' AND MKT_T_PurchaseOrder_H.poTanggal between '"& tgla &"' AND '"& tgle &"' GROUP BY MKT_T_PurchaseOrder_H.poID, MKT_T_PurchaseOrder_H.poTanggal, MKT_T_PurchaseOrder_H.po_custID, MKT_M_Customer.custNama, MKT_M_Customer.custEmail, MKT_M_Customer.custPhone1,  MKT_M_Customer.custPaymentTerm, MKT_M_Customer.custNamaCP, MKT_T_PurchaseOrder_D.po_pdID, MKT_T_PurchaseOrder_D.poQtyProduk, MKT_T_PurchaseOrder_D.poPdUnit, MKT_T_PurchaseOrder_D.poPajak,  MKT_T_PurchaseOrder_D.poHargaSatuan, MKT_M_PIGO_Produk.pdNama, MKT_M_PIGO_Produk.pdUnit, MKT_M_PIGO_Produk.pdPartNumber "
