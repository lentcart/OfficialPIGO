    ...
    <div class="wrapper">
        ...
        <div id="content">
            <div class="cont-background mt-2" style="margin-top:2rem">
                ...
                <div class="row">
                    <div class="col-lg-10 col-md-10 col-sm-12">
                        <span class="cont-text">UPDATE PURCHASE ORDER </span>
                    </div>
            ...
            <div class="cont-background mt-2">
                ...
                <div class="row">
                    <div class="col-12">
                        <input type="hidden" name="poID" id="poID" value="<%=poID%>"><input type="hidden" name="poTanggal" id="poTanggal" value="<%=DraftPO("poTanggal")%>">
                    </div>
                </div>
