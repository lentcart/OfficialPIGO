...
<% 
    ...
    InvoiceVendor_CMD.commandText = "INSERT INTO [dbo].[MKT_T_InvoiceVendor_D1]([InvAP_DLine],[InvAP_Keterangan],[InvAP_Jumlah],[InvAP_Tax],[InvAP_TotalLine],[InvAP_UpdateTime])VALUES('"& InvAP_LineFrom &"','"& InvAP_Keterangan &"',"& InvAP_Jumlah &",0,"& InvAP_TotalLine &",'"& now() &"')"
    ...
    InvoiceVendor_CMD.commandText = "SELECT * FROM MKT_T_InvoiceVendor_D1 Where InvAP_DLine = '"& InvAP_LineFrom &"' "
    'response.write InvoiceVendor_CMD.commandText & "<br><br><br>"
    set PurchaseOrder = InvoiceVendor_CMD.execute
            ...
            <tbody class="dataRekap">
                ...
                %>
                    <tr>
                        ...
                        <td class="text-center"><%=Replace(Replace(FormatCurrency(InvoiceVendorD("InvAP_Jumlah")),"$","Rp. "),".00","")%></td>
                        <td class="text-center"><%=Replace(Replace(FormatCurrency(InvoiceVendorD("InvAP_Tax")),"$","Rp. "),".00","")%></td>
                        <td class="text-center"><%=Replace(Replace(FormatCurrency(InvoiceVendorD("InvAP_TotalLine")),"$","Rp. "),".00","")%></td>
