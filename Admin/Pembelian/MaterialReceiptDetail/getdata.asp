    ...
    <tr>
        ...
        <% else %>
            <td class="text-center">
                ...
                <button class="cont-btn" onclick="window.open('buktimm.asp?mmID='+document.getElementById('mmid<%=no%>').value,'_Self')" > <i class="fas fa-print"></i> <%=MaterialReceipt("mmID")%> </button>
            </td>
            <td class="text-center">
                <%=day(Cdate(MaterialReceipt("mmTanggal")))%>/<%=Month(MaterialReceipt("mmTanggal"))%>/<%=Year(MaterialReceipt("mmTanggal"))%>
            </td>
            ...
            <td class="text-center"> 
                <button class="cont-btn" onclick="window.open('posting-jurnal.asp?mmID='+document.getElementById('mmid<%=no%>').value,'_Self')"> POSTING JURNAL </button> 
            </td>
            <% else %>
            <td class="text-center"> 
                <button class="cont-btn" onclick="window.open('../../GL/GL-Jurnal/jurnal-voucher.asp?JR_ID='+document.getElementById('JRD_ID<%=no%>').value,'_Self')"> <i class="fas fa-print"></i> <%=MaterialReceipt("mm_JR_ID")%> </button> 
            </td>
            <% end if %>
        <% end if %>
        <script>
