...
<%
	...
	MaterialReceipt_CMD.activeConnection = MM_PIGO_String
        ...
        MaterialReceipt_CMD.commandText = "SELECT poID FROM MKT_T_PurchaseOrder_H WHERE poAktifYN = 'Y' group by poID "
            ...
            <div class="cont-background mt-2">
                <div class="row">
                    <div class="col-lg-2 col-md-6 col-sm-12">
                        ...
                        <input type="Date" class="tanggalmm text-center cont-form" name="tanggalmm" id="cont" value="" ><br>
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    <div class="col-lg-12 col-md-12 col-sm-6 data-mmID">
                        <button onclick="AddBussinesPart()" name="btn-add" id="btn-add" class="cont-btn" style="display:block;"><i class="fas fa-folder-plus"></i>&nbsp; Add PurchaseOrder </button>
                    </div>
                </div>
