...
<!--#include file="../../loaderpage.asp"-->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <table class="align-items-center cont-text table tb-transaksi table-bordered">
                        ...
                        <tbody class="dataRekap">
                                ...
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            <div class="col-1">
                                                <span class="close" id="close<%=no%>"> X </span>
                                            </div>
                                        </div>
                                        <hr>
                                        <%
                                        ...
                                        <div class="row mt-3 ">
                                            <div class="col-12 text-center">
                                                <button class="cont-btn" id="konfirmasi"onclick="konfirmasi('<%=Transaksi("trID")%>','<%=Transaksi("sl_custID")%>','<%=Transaksi("Amount")%>')" style="width:max-content"> Konfirmasi </button> &nbsp; &nbsp;
                                                <button class="cont-btn" id="done" style="width:max-content; display:none"> Selesai </button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            var span<%=no%>     = document.getElementById("close<%=no%>");
    ...
    <script>
        ...
        function konfirmasi(a, b, c){
            var TransaksiID = a;
            var SellerID    = b;
            var Amount      = c;
            $.ajax({
                type: "get",
                url: "update-saldoseller.asp",
                data: {
                    TransaksiID,
                    SellerID,
                    Amount
