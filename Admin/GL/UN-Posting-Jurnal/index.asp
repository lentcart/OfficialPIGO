...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            <form class="" action="proses.asp" method="GET">
            <div class="cont-background ">
                ...
                <div class="row text-center">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <span class="cont-judul"> UN-POSTING BULANAN  </span>
                    </div>
                </div>
                ...
                <div class="row text-center mt-2 mb-2">
                    <div class="col-6">
                        ...
                        <select  class="cont-form" name="Bulan" id="Bulan" aria-label="Default select example" required>
            ...
            <div class="cont-background mt-2"  id="list-jurnal" style="display:block">
                <div class="row">
                    <div class="col-6">
                    <input type="submit" class="cont-btn" name="Proses" id="Proses" value="Proses">
                    </div>
                    <div class="col-6">
