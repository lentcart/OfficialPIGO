...
<html lang="en">
    ...
    <script>
        function getAccountID1(){
            $.ajax({
                type: "get",
                url: "load-Account1.asp",
                success: function (url) {
                    document.getElementById("cont-acc").style.display = "block"
                    $('.cont-acc').html(url);
                }
            });
        }
        function getAccountID2(){
            $.ajax({
                type: "get",
                url: "load-Account2.asp",
                success: function (url) {
                    console.log(url);
                $('.cont-acc').html(url);
                document.getElementById("cont-acc").style.display = "block"
        ...
        function getAccountName1(){
            $.ajax({
                type: "get",
                url: "get-ACName1.asp?CA_Name="+document.getElementById("AccountID1").value,
                success: function (url) {
                $('.cont-acc').html(url);
                }
            });
        ...
        function getAccountName2(){
            $.ajax({
                type: "get",
                url: "get-ACName2.asp?CA_Name="+document.getElementById("AccountID2").value,
                success: function (url) {
                $('.cont-acc').html(url);
                }
            });
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="cont-background ">
                ...
                <div class="row mt-2">
                    <div class="col-12">
                        <span class="cont-text"> PERIODE TANGGAL </span> <br>
                    </div>
                </div>
                <div class="row text-center mt-1">
                    <div class="col-6">
                        <input class="text-center cont-form" type="Date" name="tgla" id="tgla" value="">
                    </div>
                    <div class="col-6">
                        <input class="text-center cont-form" type="Date" name="tgle" id="tgle" value="">
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-12">
                        <span class="cont-text"> KODE ACCOUNT JURNAL </span> <br>
                    </div>
                </div>
                <div class="row text-center mt-1">
                    <div class="col-6 cont-acc-1">
                        <input onfocus="getAccountID1()" onkeyup="getAccountName1()" class="text-center cont-form" type="text" name="AccountID1" id="AccountID1" value="">
                    </div>
                    <div class="col-6 cont-acc-2">
                        <input onfocus="getAccountID2()" onkeyup="getAccountName2()" class="text-center cont-form" type="text" name="AccountID2" id="AccountID2" value="">
                    </div>
                </div>
                <div class="cont-acc mt-2 mb-2 p-1" id="cont-acc" style="display:none">
                ...
                <div class="row text-center mt-1">
                    <div class="col-12">
                        <select onchange="getListData()" class="cont-form" name="Kategori" id="Kategori" aria-label="Default select example" required>
                            <option value=""> PILIH </option>
                            <option value="1"> SEMUA </option>
                            <option value="2"> ADA TRANSAKSI SAJA </option>
                        </select>
                    </div>
                </div>
            </div>
