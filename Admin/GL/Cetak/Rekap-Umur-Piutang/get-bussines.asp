...
<%
	...
	BussinesPartner_cmd.activeConnection = MM_PIGO_String
        ...
        BussinesPartner_cmd.commandText = "SELECT MKT_M_Customer.custNama, MKT_M_Customer.custID FROM GL_T_RekapUmurPiutang LEFT OUTER JOIN MKT_M_Customer ON GL_T_RekapUmurPiutang.RUP_custID = MKT_M_Customer.custID WHERE MKT_M_Customer.custNama LIKE '%"& custNama &"%' GROUP BY MKT_M_Customer.custNama, MKT_M_Customer.custID ORDER BY custNama ASC "
