            ...
            <div class="cont-background ">
                ...
                <div class="row text-center mt-2 mb-2">
                    <div class="col-6">
                        ...
                        <input class="text-center cont-form" type="text" name="tgla" id="tgla" value="" maxlength="12">
                    </div>
                    <div class="col-6">
                        <span class="cont-text"> TAHUN </span> <br>
                        <input class="text-center cont-form" type="text" name="tgle" id="tgle" value="<%=year(CDate(NOW()))%>">
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-12">
