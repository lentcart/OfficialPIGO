...
<% 
    ...
    KalkulasiFiskal_CMD.commandText = "DELETE FROM GL_M_Fiskal_D WHERE FMD_ID = '"& FMD_ID &"' AND FMD_CA_ID = '"& FMD_CA_ID &"' AND FMD_Value = '"& FMD_Value &"' "
    'response.write KalkulasiFiskal_CMD.commandText
    set DeleteFiskalD = KalkulasiFiskal_CMD.execute
