...
<%
    ...
    Kas_Detail_CMD.commandText = "Select * From GL_T_CashBank_H Where CB_ID = '"& CB_ID &"' "
    ...
    Kas_Detail_CMD.commandText = " SELECT * FROM [dbo].[GL_T_CashBank_D] WHERE CBD_ID = '"& CB_ID &"' "
...
<html lang="en">
    ...
    <script>
        ...
        function AddRincianBaru(){
            document.getElementById("Rincian-Baru").style.display = "block";
            document.getElementById("btnrincianbaru").style.display = "none";
            document.getElementById("btnbatal").style.display = "block";
        }
        function BatalRincianBaru(){
            document.getElementById("Rincian-Baru").style.display = "none";
            document.getElementById("btnrincianbaru").style.display = "block";
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="cont-background mt-2 mb-2">
                <div class="row mt-2">
                    <div class="col-2 ">
                        <input type="hidden" name="CB_ID" id="CB_ID" value="<%=CB_ID%>">
                ...
                <div class="row">
                    ...
                    <div class="col-2" >
                        <span class="cont-text me-4"> </span><br>
                        <button onclick="AddRincianBaru()" name="btnrincianbaru" id="btnrincianbaru" class="cont-btn" style="display:block"> Rincian Baru </button>
                        <button onclick="BatalRincianBaru()"  name="btnbatal" id="btnbatal" class="cont-btn" style="display:none"> Bata </button>
                    </div>
                </div>
            </div>
            <div class="cont-background mt-2">
                <div id="Tambah-Rincian">
                    <div class="Rincian-Baru" id="Rincian-Baru" style="display:none">
                    <div class="row">
                        <div class="col-6">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-2">
                            <Button onclick="window.open('Bukti-Kas.asp?CB_ID='+document.getElementById('CB_ID').value,'_Self')"  class="cont-btn" > Cetak </button>
                        </div>
                        <div class="col-2">
