...
<% 
    ...
    loadproduk_CMD.commandText = "DELETE FROM MKT_T_Permintaan_Barang_D WHERE Perm_pdID = '"& pdID &"' AND Perm_IDH = '"& permID &"'   "
...
<div class="row">
    <div class="col-12">
        <button class="cont-btn" onclick="complete('<%=permID%>')"> Complete </button>
    </div>
</div>