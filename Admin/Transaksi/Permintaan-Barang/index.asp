...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            <div class="cont-background mt-2" style="margin-top:2rem">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-12">
                        <button onclick="window.open('List-Permintaan.asp','_Self')" name="btn-add" id="btn-add" class="cont-btn" style="display:block"><i class="fas fa-clipboard-list"></i>&nbsp;&nbsp; LIST PERMINTAAN</button> 
                    </div>
                </div>
            </div>
                ...
                <div class="cont-addpermintaan mb-2" id="cont-addpermintaan"  style="display:block">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            ...
                            <select class="cont-form" name="PermTujuan" id="cont" aria-label="Default select example" required>
                                ...
                                <option value="2">Pemakaian Sendiri</option>
                            </select>
                        </div>
                        <div class="col-lg-4 col-md-8 col-sm-8">
                            <span class="cont-text"> No Permintaan  </span><br>
                            <input  type="Text" class=" PermNo cont-form" name="PermNo" id="cont" value=""><br>
                        </div>
                        <div class="col-lg-2 col-md-6 col-sm-6">
                            <span class="cont-text"> Tanggal Permintaan  </span><br>
                            <input  type="Date" class="PermTanggal cont-form" name="PermTanggal" id="cont" value=""><br>
                        </div>
                        <div class="col-lg-2 col-md-6 col-sm-6">
                            <span class="cont-text"> Jenis Permintaan  </span><br>
                    ...
                    <div class="row mt-2">
                        <div class="col-lg-2 col-md-4 col-sm-3">
                            ...
                            <input onkeyup="return getKeySupplier()"type="text" class="keysearch cont-form" name="keysearch" id="keysearch" value=""><br>
                        </div>
                    ...
                    <div class="cont-produk-permintaan mt-2" id="cont-tambahproduk" style="display:none">
                        <div class="row mt-2 ">
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <span class="cont-text"> Kategori Produk </span><br>
                                <select disabled="true" onchange="addkategori()" class="kategori cont-form" name="kategori" id="kategori" aria-label="Default select example" required>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 data-partnumber">
                                ...
                                <select disabled class="cont-form" name="partnumber" id="partnumber" aria-label="Default select example" required>
                        ...
                        <div class="cont-dataproduk">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    ...
                                    <select disabled="true" class="kategori cont-form" name="kategori" id="kategori" aria-label="Default select example" required>
                                ...
                                <div class="col-lg-2 col-md-6 col-sm-4">
                                    <span class="cont-text"> Total Harga Jual</span><br>
                                    <input readonly type="text" class="  cont-form" name="pdpermintaan" id="prodpenawaran" value="" ><br>
                                </div>
                                <div class="col-lg-2 col-md-6 col-sm-6">
            ...
            <div class="row mt-3">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="data-produkpermintaan" id="data-produkpermintaan">
    ...
    function batal() {
        ...
        document.getElementById("data-produkpermintaan").style.display = "none"
    ...
    function tambahproduk() {
            ...
            var Perm_pdHarga    = $('input[name=pdhargajual]').val();
            var Perm_pdUpTo     = $('input[name=pdUpto]').val();
            var Perm_pdPPN      = $('select[name=ppn]').val();
            if ( Perm_pdPPN == ""){
                $('#ppn').focus();
            }else if (Perm_pdUpTo == ""){
                $('#pdUpto').focus();
            }else if (Perm_pdHarga == "0"){
                $('#pdhargajual').focus();
            }else if (Perm_pdQty == "0"){
                $('#pdQty').focus();
            }else {
                $.ajax({
                    type: "GET",
        ...
        function complete(id){
            window.open(`bukti-permintaan.asp?PermID=${id}`)
            location.reload();
        }
</script>
