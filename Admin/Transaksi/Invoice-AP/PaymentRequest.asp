...
<%
	...
	Merchant_cmd.commandText = "SELECT MKT_M_Customer.custID, MKT_M_Customer.custNama, MKT_M_Customer.custPaymentTerm, MKT_T_InvoiceVendor_D.InvAP_Ket, MKT_T_PurchaseOrder_H.poDesc FROM MKT_M_Customer LEFT OUTER JOIN MKT_T_PurchaseOrder_H ON MKT_M_Customer.custID = MKT_T_PurchaseOrder_H.po_custID RIGHT OUTER JOIN MKT_T_InvoiceVendor_H LEFT OUTER JOIN MKT_T_InvoiceVendor_D LEFT OUTER JOIN MKT_T_InvoiceVendor_D1 ON MKT_T_InvoiceVendor_D.InvAP_IDH = MKT_T_InvoiceVendor_D1.InvAP_DLine ON MKT_T_InvoiceVendor_H.InvAPID = MKT_T_InvoiceVendor_D.InvAP_IDH ON  MKT_M_Customer.custID = MKT_T_InvoiceVendor_H.InvAP_custID WHERE MKT_T_InvoiceVendor_H.InvAPID = '"& InvAPID &"' AND MKT_T_InvoiceVendor_H.InvAP_Tanggal = '"& InvAP_Tanggal &"' GROUP BY MKT_T_InvoiceVendor_H.InvAPID, MKT_T_InvoiceVendor_H.InvAP_Tanggal, MKT_M_Customer.custID, MKT_M_Customer.custNama, MKT_M_Customer.custPaymentTerm, MKT_T_InvoiceVendor_D.InvAP_Ket, MKT_T_PurchaseOrder_H.poDesc"
    ...
    <head>
        ...
        <script>
            ...
            var date = today.getFullYear()+'-'+(today.getMonth()+1)+'-'+today.getDate();
                window.print();
                document.title = "BuktiFaktur-<%=InvAPID%>-"+today.getDate()+'-'+(today.getMonth()+1)+'-'+today.getFullYear()+"-PIGO";
            ...
            <div class="page">
                <div class="subpage">
                    ...
                    <div class="row mt-3" style="font-size:10px">
                        <div class="col-2">
                            <span class="txt-desc"> BussinesPartner </span>
                        </div>
                        <div class="col-5">
                        <% if InvoiceVendor("custID") <> "C001-CASH" then  %>
                            <span class="txt-desc"> <span class="txt-desc"> : </span>&nbsp;&nbsp; <%=InvoiceVendor("custNama")%> </span><br>
                        <% else %>
                            <span class="txt-desc"> <span class="txt-desc"> : </span>&nbsp;&nbsp; <%=InvoiceVendor("poDesc")%> </span><br>
                        <% end if %>
                        </div>
                        <div class="col-2">
                        ...
                        <div class="col-7">
                            <div class="row">
                                <div class="col-3 me-3">
                                    <span class="txt-desc"> Receipt No </span>
                                </div>
                                <div class="col-5">
                                <%
                                    Merchant_cmd.commandText = "SELECT MKT_T_TukarFaktur_D.TF_mmID, MKT_T_MaterialReceipt_D1.mm_poID FROM MKT_T_MaterialReceipt_D1 RIGHT OUTER JOIN MKT_T_MaterialReceipt_H ON MKT_T_MaterialReceipt_D1.mmID_D1 = MKT_T_MaterialReceipt_H.mmID LEFT OUTER JOIN MKT_T_TukarFaktur_D ON MKT_T_MaterialReceipt_H.mmID = MKT_T_TukarFaktur_D.TF_mmID RIGHT OUTER JOIN MKT_T_TukarFaktur_H ON LEFT(MKT_T_TukarFaktur_D.TFD_ID, 16) = MKT_T_TukarFaktur_H.TF_ID WHERE MKT_T_TukarFaktur_H.TF_ID = '"& TukarFaktur("InvAP_Line") &"' GROUP BY  MKT_T_TukarFaktur_D.TF_mmID, MKT_T_MaterialReceipt_D1.mm_poID ORDER BY  MKT_T_TukarFaktur_D.TF_mmID desc "
                                    'response.Write Merchant_cmd.commandText & "<br><br>"
                                    set MaterialReceipt = Merchant_cmd.execute
                                %>
                                <% do while not MaterialReceipt.eof%>
                                    <span class="txt-desc"> <span class="txt-desc"> : </span>&nbsp;&nbsp; <%=MaterialReceipt("TF_mmID")%> </span><br>
                            ...
                            <div class="row">
                                <div class="col-3 me-3">
                                    <span class="txt-desc"> PO ID </span>
                                </div>
                                <div class="col-5">
                                <%
                                    Merchant_cmd.commandText = "SELECT MKT_T_TukarFaktur_D.TF_mmID, MKT_T_MaterialReceipt_D1.mm_poID FROM MKT_T_MaterialReceipt_D1 RIGHT OUTER JOIN MKT_T_MaterialReceipt_H ON MKT_T_MaterialReceipt_D1.mmID_D1 = MKT_T_MaterialReceipt_H.mmID LEFT OUTER JOIN MKT_T_TukarFaktur_D ON MKT_T_MaterialReceipt_H.mmID = MKT_T_TukarFaktur_D.TF_mmID RIGHT OUTER JOIN MKT_T_TukarFaktur_H ON LEFT(MKT_T_TukarFaktur_D.TFD_ID, 16) = MKT_T_TukarFaktur_H.TF_ID WHERE MKT_T_TukarFaktur_H.TF_ID = '"& TukarFaktur("InvAP_Line") &"' GROUP BY  MKT_T_TukarFaktur_D.TF_mmID, MKT_T_MaterialReceipt_D1.mm_poID ORDER BY  MKT_T_TukarFaktur_D.TF_mmID desc "
                                ...
                                <% do while not PurchaseOrder.eof%>
                                    <span class="txt-desc"> <span class="txt-desc"> : </span>&nbsp;&nbsp; <%=PurchaseOrder("mm_poID")%> </span><br>
                        ...
                        <div class="col-5">
                            <div class="row" style="font-size:10px">
                                <div class="col-4 me-2">
                                    ...
                                    <span class="txt-desc"> J Tempo  </span><br>
                                </div>
                                <div class="col-7">
                    ...
                    <div class="row" style="font-size:10px">
                        <div class="col-7">
                            <div class="row">
                                ...
                                <div class="col-5">
                                    <span class="txt-desc"> <span class="txt-desc"> : </span>&nbsp;&nbsp; - </span><br>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-3 me-3">
                    ...
                    <div class="row  mt-4  text-center">
                        <div class="col-12">
                            <span class="txt-desc" style="font-size:22px"><u>  P A Y M E N T &nbsp; R E Q U E S T  </u></span><br>
                            <span class="txt-desc"><%=InvAPID%>/<%=Day(CDate(InvAP_Tanggal))%>/<%=Month(CDate(InvAP_Tanggal))%>/<%=Year(CDate(InvAP_Tanggal))%>  </span><br>
                        </div>
                    </div>
                    <% if InvoiceVendor("InvAP_Ket") = "TF" then %>
                        <%
                            produk_cmd.commandText = "SELECT  MKT_T_PurchaseOrder_D.po_pdID, MKT_M_PIGO_Produk.pdNama AS Keterangan, MKT_M_PIGO_Produk.pdUnit, MKT_T_PurchaseOrder_D.poQtyProduk, MKT_T_PurchaseOrder_D.poPdUnit,MKT_T_PurchaseOrder_D.poPajak, MKT_T_PurchaseOrder_D.poHargaSatuan as Jumlah, (poQtyProduk*poHargaSatuan) AS TotalLine FROM MKT_T_PurchaseOrder_D LEFT OUTER JOIN MKT_M_PIGO_Produk ON MKT_T_PurchaseOrder_D.po_pdID = MKT_M_PIGO_Produk.pdID RIGHT OUTER JOIN MKT_T_PurchaseOrder_H ON MKT_T_PurchaseOrder_D.poID_H = MKT_T_PurchaseOrder_H.poID RIGHT OUTER JOIN MKT_T_TukarFaktur_D1 ON MKT_T_PurchaseOrder_H.poID = MKT_T_TukarFaktur_D1.TFD1_poID RIGHT OUTER JOIN MKT_T_TukarFaktur_H ON LEFT(MKT_T_TukarFaktur_D1.TFD1_ID,16) = MKT_T_TukarFaktur_H.TF_ID RIGHT OUTER JOIN MKT_T_InvoiceVendor_D ON MKT_T_TukarFaktur_H.TF_ID = MKT_T_InvoiceVendor_D.InvAP_Line RIGHT OUTER JOIN MKT_T_InvoiceVendor_H ON MKT_T_InvoiceVendor_D.InvAP_IDH = MKT_T_InvoiceVendor_H.InvAPID WHERE MKT_T_InvoiceVendor_H.InvAP_custID = '"& InvoiceVendor("custID") &"' and MKT_T_InvoiceVendor_H.InvAPID = '"& InvAPID &"' GROUP BY MKT_T_PurchaseOrder_H.poID, MKT_T_PurchaseOrder_D.po_pdID, MKT_M_PIGO_Produk.pdNama, MKT_M_PIGO_Produk.pdUnit, MKT_T_PurchaseOrder_D.poQtyProduk, MKT_T_PurchaseOrder_D.poPdUnit, MKT_T_PurchaseOrder_D.poPajak, MKT_T_PurchaseOrder_D.poHargaSatuan "
                    ...
                    <% else %>
                        <%
                            produk_cmd.commandText = "SELECT MKT_T_InvoiceVendor_D1.InvAP_Keterangan AS Keterangan, MKT_T_InvoiceVendor_D1.InvAP_Jumlah as Jumlah ,1 as poQtyProduk, MKT_T_InvoiceVendor_D1.InvAP_Tax as Tax, MKT_T_InvoiceVendor_D1.InvAP_TotalLine as TotalLine FROM MKT_T_InvoiceVendor_D LEFT OUTER JOIN MKT_T_InvoiceVendor_D1 ON MKT_T_InvoiceVendor_D.InvAP_Line = MKT_T_InvoiceVendor_D1.InvAP_DLine RIGHT OUTER JOIN MKT_T_InvoiceVendor_H ON MKT_T_InvoiceVendor_D.InvAP_IDH = MKT_T_InvoiceVendor_H.InvAPID Where MKT_T_InvoiceVendor_H.InvAPID = '"& InvAPID &"' AND MKT_T_InvoiceVendor_H.InvAP_custID = '"& InvoiceVendor("custID") &"'  "
                            'response.write produk_cmd.commandText
                            set produk = produk_cmd.execute
                            produksatuan = "-"
                            tax = produk("Tax")
                            ...
                            <table class="table tb-transaksi table-bordered table-condensed mt-2" style="font-size:12px">   <thead>
                                ...
                                %>
                                    <tr>
                                        ...
                                        <td class="text-center"><%=produksatuan%> </td>
