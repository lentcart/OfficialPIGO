...
<% 
    ...
    BussinesPart_CMD.commandText = "SELECT custID, custNama FROM MKT_M_Customer where custNama like '%"& bpNama &"%' Order BY custNama ASC "
...
<select onchange="return getbussines()"  class=" cont-text cont-form" name="bussinespartner" id="bussinespartner" aria-label="Default select example" required>
