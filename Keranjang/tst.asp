...
<%
	...
	Seller_cmd.commandText = "SELECT MKT_M_Seller.slName, MKT_T_Keranjang_H.cart_slID, MKT_T_Keranjang_H.cart_custID FROM MKT_M_Seller RIGHT OUTER JOIN  MKT_T_Keranjang_H ON MKT_M_Seller.sl_custID = MKT_T_Keranjang_H.cart_slID WHERE (MKT_T_Keranjang_H.cart_custID = '"&request.cookies("custID")&"') "& FilterFix &"  GROUP BY MKT_M_Seller.slName, MKT_T_Keranjang_H.cart_slID, MKT_T_Keranjang_H.cart_custID" 
    ...
    <div class="header">
        <div class="container" style="margin-top:15px">
            <div class="row align-items-center">
                <div class="col-2">
                    <span class="text-header"> Official PIGO</span>
                </div>
                
                <div class="col-3">
                    <span class="text-header"> CheckOut </span>
                </div>
            </div>
        </div>
    </div>
    <div class="container mb-2" style="margin-top:5rem">
    <form class="form-tr" action="P-Transaksi.asp" method="POST">
        <!-- Alamat Penerima -->
                ...
                <div class="col-9">
                    ...
                    <div class="row align-items-center mt-2 ">
                        <div class="col-3">
                            ...
                            <span class="txt-pesanan" >[<%=alamat("almPhonePenerima")%>]</span><br>
                            <span class="txt-pesanan" >[<%=alamat("almLabel")%>]</span><br>
                        </div>
                        <div class="col-7">
                            <span class="txt-pesanan" > <%=alamat("almLengkap")%></span><br>
                            <span class="txt-pesanan" > <%=alamat("almKel")%>, <%=alamat("almKec")%>,<%=alamat("almKota")%>, <%=alamat("almProvinsi")%></span><br>
                            <span class="txt-pesanan" > <%=alamat("almkdpos")%></span><br>
                        </div>
                        <div class="col-2">
            ...
            <div class="col-9">
                <div class="row align-items-center">
                    <div class="col-12">
                        ...
                        <% 
                            alamattoko_cmd.commandText = "SELECT MKT_M_Alamat.almKota, MKT_M_Alamat.almID FROM MKT_M_Seller LEFT OUTER JOIN  MKT_M_Alamat ON MKT_M_Seller.sl_almID = MKT_M_Alamat.almID RIGHT OUTER JOIN  MKT_T_Keranjang_H ON MKT_M_Seller.sl_custID = MKT_T_Keranjang_H.cart_slID where MKT_T_Keranjang_H.cart_slID = '"& seller("cart_slID") &"' GROUP BY  MKT_M_Alamat.almKota, MKT_M_Alamat.almID "
                        ...
                        <%
                            produk_cmd.commandText = "SELECT MKT_M_Alamat.almKota, MKT_M_Alamat.almID, MKT_M_Produk.pdImage1, MKT_M_Produk.pdNama, MKT_M_Produk.pdID, MKT_M_Produk.pdBerat, MKT_M_Produk.pdVolume, MKT_M_Produk.pdHargaJual, MKT_T_Keranjang_H.cart_slID, MKT_T_Keranjang_H.cartQty, MKT_M_Produk.pd_almID FROM MKT_M_Produk LEFT OUTER JOIN  MKT_M_Alamat ON MKT_M_Produk.pd_almID = MKT_M_Alamat.almID RIGHT OUTER JOIN  MKT_T_Keranjang_H ON MKT_M_Produk.pdID = MKT_T_Keranjang_H.cart_pdID  where (MKT_T_Keranjang_H.cart_slID = '"& seller("cart_slID") &"')  AND (MKT_T_Keranjang_H.cart_custID = '"& seller("cart_custID") &"') " &  FilterFix  &" GROUP BY MKT_M_Alamat.almKota, MKT_M_Alamat.almID, MKT_M_Produk.pdImage1, MKT_M_Produk.pdNama, MKT_M_Produk.pdID, MKT_M_Produk.pdBerat, MKT_M_Produk.pdVolume, MKT_M_Produk.pdHargaJual, MKT_T_Keranjang_H.cart_slID, MKT_T_Keranjang_H.cartQty, MKT_M_Produk.pd_almID "
                            'response.write produk_cmd.commandText
                        ...
                        <div class="row align-items-center mt-2">
                            ...
                            <div class="col-2 text-center ">
                                <input class="txt-pesanan input-txt" type="text" name="pdHargaJual" id="pdHargaJual" value="<%=produk("pdHargaJual")%>" style="width:7rem"> <br>
                            </div>
                            <div class="col-2 text-center ">
                            ...
                            <!--<div class="row align-items-center">
                                <div class="col-12">
                                    ...
                                    <label class="form-check-label text-span" for="flexCheckChecked"> Asuransi </label>
                                </div>
                            </div>
                            <div class="row align-items-center">
                                <div class="col-12">
